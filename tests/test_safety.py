...
class SafetyTests(unittest.TestCase):
    ...
    def test_wtioil_does_not_resolve_to_brent_oil(self):
        fake_info = FakeInfo()
        mids = {"xyz:BRENTOIL": "80"}
        self.assertEqual(normalize_coin(fake_info, "WTIOIL", "XYZ"), "WTIOIL")
        self.assertIsNone(find_mid(mids, fake_info.name_to_coin, "WTIOIL", "XYZ"))
